...
for (i in 1:iterations) {
    ...
    # test the lm
    testResults <- predict(linearModel, newdata = train.df) # test the lm
    mse[i, 1] <- with(test, tmean((strength - testResults)^2)) # put the MSE in the appropriate row, first column
